...
from baselines.common.vec_env import VecNormalize, DummyVecEnv
...
if __name__ == '__main__':
    ...
    nvenv = VecNormalize(venv, ob=True, ret=False)
    model.set_env(nvenv)

    model.learn(total_timesteps=10000, tb_log_name="PPO2_5M_1")
    model.save("PPO2_10k_1")
